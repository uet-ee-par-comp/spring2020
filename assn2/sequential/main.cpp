...
int main(int argc, char *argv[]) 
{
	...
	cout << "rgb2gray: \t\t" << total.getElapsed() << " seconds." << endl;
        
        prev_time = total.getElapsed();
	...
	cout << "histogram1D: \t\t" << total.getElapsed() - prev_time << " seconds." << endl;
	...
	cout << "contrast1D: \t\t" << total.getElapsed() - prev_time << " seconds." << endl;
	...
	cout << "triangularSmooth: \t" << total.getElapsed() - prev_time << " seconds." << endl;
	...
	// Wrap up
	cout << "Total execution time: \t" << total.getElapsed() << " seconds." << endl << endl;
